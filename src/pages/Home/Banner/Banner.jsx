    ...
    return (
        <div className="carousel w-full h-[600px]">
            <div id="slide1" className="carousel-item relative w-full">
                ...
                <div className="absolute flex items-center h-full left-0 rounded-lg top-0 bg-gradient-to-r
                 from-[#151515] to-[#rgba(21, 21, 21, 0.00)]">
                    <div className=' w-1/3 text-white space-y-5 pl-10'>
